...
return [
    ...
    */
    ...
    'date_format' => 'Το πεδίο :attribute δεν είναι της σωστής μορφής.',
    ...
    */
    ...
    'custom' => [
        ...
        'mixedCase' => 'Το πεδίο :attribute πρέπει να περιέχει τουλάχιστον ένα κεφαλαίο και ένα πεζό γράμμα.',
        ...
        'uncompromised' => 'Το συγκεκριμένο :attribute έχει εμφανιστεί σε μια διαρροή δεδομένων. Παρακαλώ επιλέξτε ένα διαφορετικό :attribute.'
    ],
