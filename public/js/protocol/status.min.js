...
$(document).ready(function () {
  var protocolReactivateBtn = document.getElementById('reactivateProtocol');
  var protocolCancelBtn = document.getElementById('cancelProtocol');
...
var changeStatusModal = document.getElementById('changeProtocolStatusModal'); // Reactivate Protocol Action

function reactivateProtocol() {
  var protocolId = document.getElementById('reactivateProtocol').value;
  var reactivateMsg = changeStatusModal.getElementsByClassName('reactivation-message')[0];
  var submitBtn = changeStatusModal.getElementsByClassName('modal-submit')[0];
...
function cancelProtocol() {
  var protocolId = document.getElementById('cancelProtocol').value;
  var cancelBtn = changeStatusModal.getElementsByClassName('cancel-message')[0];
  var submitBtn = changeStatusModal.getElementsByClassName('modal-submit')[0];
...
protocolStatusAjax = function protocolStatusAjax(protocolId, action) {
  var confirmationMsg = changeStatusModal.getElementsByClassName('modal-message')[0];
...
function hideInitialMessages() {
  var cancelMsg = changeStatusModal.getElementsByClassName('cancel-message')[0];
  var reactivateMsg = changeStatusModal.getElementsByClassName('reactivation-message')[0];
